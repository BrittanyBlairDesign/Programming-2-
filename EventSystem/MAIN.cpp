...
///////////////////////////////////////////////////////////////////////////////////////////
/// Using the CRTDBG.h to find memory leaks.
/// but unfortunately the macro isn't working as expected (supposed to show file and line)
///////////////////////////////////////////////////////////////////////////////////////////
...
// I cant get vld to work, and ive searhed all over the internet for solutions. 
// #include "vld.h"
// Ive installed a Git hub tool to find leaks.
#include <vld.h>
...
int main()
{
	...
	// pButton needs to be a shared pointer because the Event disbatcher is being coppied.
	...
	while (true)
	{
		...
		switch (choice)
		{
			...
			case Input::kQuit:
			{
				...
				// Event Disbatcher needs to be deleted when the game ends.
				pButton->~EventDispatcher();
				break;
			}
		}
		...
		if (exit)
		{
			// Just making sure Everyting is deleted after the player decides to quit.
			pButton->~EventDispatcher();
			break;
		}
	}
