...
{
	Deck deck;
	PlayingCard* pCheckPile[52]{ nullptr };
	for (int i = 0; i < 52; ++i)
	{
...
bool ShuffleChangesCardOrder()
{
	...
	PlayingCard* pPiles[2][52]{ nullptr };
	...
	for (int test = 0; test < kTestCount; ++test)
	{
		...
		PlayingCard** ppPile1 = pPiles[currentPileIndex];
		PlayingCard** ppPile2 = pPiles[1 - currentPileIndex];
